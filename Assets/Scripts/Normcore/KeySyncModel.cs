...
{
    [RealtimeProperty(1, true, true)] private string _keyName;
    [RealtimeProperty(2, true, true)] private EKeyState _keyState;
}
...
public partial class KeySyncModel : RealtimeModel {
    ...
    private ReliableProperty<string> _keyNameProperty;
    
    private ReliableProperty<uint> _keyStateProperty;
    
    #endregion
    
    public KeySyncModel() : base(null) {
        _keyNameProperty = new ReliableProperty<string>(1, _keyName);
        _keyStateProperty = new ReliableProperty<uint>(2, (uint) _keyState);
    }
    
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        _keyNameProperty.UnsubscribeCallback();
        _keyStateProperty.UnsubscribeCallback();
    }
